...
for (let i = 0; i < employees.length; i++) {
    let currentDepartment = employees[i].department;
    if (departmentCount[currentDepartment]) {
        departmentCount[currentDepartment] = departmentCount[currentDepartment] + 1;
    } else {
        departmentCount[currentDepartment] = 1;
    }
}
